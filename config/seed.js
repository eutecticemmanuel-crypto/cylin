    ...
    const sampleProducts = [
      {
        ...
        description: 'High-quality, low-VOC interior paint with excellent coverage and durability.',
        category: 'Paints',
        price: 45.99,
        features: ['Low VOC', 'Excellent Coverage', 'Washable Finish', '1 Gallon'],
        isPro: false
      },
      {
        name: 'Exterior WeatherShield Paint',
        description: 'Professional-grade exterior paint designed to withstand harsh weather conditions.',
        category: 'Paints',
        price: 52.99,
        features: ['Weather Resistant', 'Fade Resistant', 'Mildew Resistant', '5-Year Warranty'],
        isPro: true
      },
      {
        name: 'Professional Paint Sprayer',
        description: 'Electric airless paint sprayer for fast, professional results.',
        category: 'Tools',
        price: 199.99,
        features: ['Airless Technology', 'Variable Pressure', 'Easy Cleanup', 'Professional Grade'],
        isPro: true
      },
      {
        name: 'Paint Brush Set',
        description: 'Set of 5 professional-grade paint brushes in various sizes.',
        category: 'Tools',
        price: 29.99,
        features: ['Synthetic Bristles', 'Comfortable Handle', 'Various Sizes', 'Durable'],
        isPro: false
      },
      {
        name: 'Color Consultation Service',
        description: 'Professional color consultation to help you choose the perfect colors for your space.',
        category: 'Services',
        price: 150.00,
        features: ['In-Home Consultation', 'Color Samples', 'Design Recommendations', '2-Hour Session'],
        isPro: true
      }
    ];
